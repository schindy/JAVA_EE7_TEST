...
public class AktionEditTest {
	...
	public static Archive<?> createTestArchive() {
		return ShrinkWrap.create(WebArchive.class, "test.war").addClasses(Aktion.class, Konto.class, Spende.class, AktionEditController.class).addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml");
	}
